...
class TestUserModel:
    ...
    def test_create_user(self, user_model, mock_collection):
        # Setup
        mock_collection.insert_one.return_value = MagicMock(inserted_id=ObjectId("60d21b4667d0d8992e610c85"))
        
        # Execute
        result = user_model.create_user("testuser", "test@example.com", "password123", "student")
