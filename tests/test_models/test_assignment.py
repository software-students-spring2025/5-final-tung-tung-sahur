...
class TestAssignmentModel:
    ...
    def test_create_assignment(self, assignment_model, mock_collection):
        ...
        mock_collection.insert_one.return_value = MagicMock(inserted_id=ObjectId("60d21b4667d0d8992e610c86"))
    ...
    def test_get_assignment(self, assignment_model, mock_collection):
        ...
        mock_collection.find_one.assert_called_once_with({"_id": ObjectId(assignment_id)})
    ...
    def test_update_assignment(self, assignment_model, mock_collection):
        # Setup
        assignment_id = "60d21b4667d0d8992e610c86"
        update_data = {"title": "Updated Assignment", "description": "Updated description"}
    ...
    def test_delete_assignment(self, assignment_model, mock_collection):
        ...
        # Verify
        assert result is True
        mock_collection.delete_one.assert_called_once_with({"_id": ObjectId(assignment_id)})
