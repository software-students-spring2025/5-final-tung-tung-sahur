...
class TestSubmissionModel:
    ...
    def test_create_submission(self, submission_model, mock_collection):
        ...
        mock_collection.insert_one.return_value = MagicMock(inserted_id=ObjectId("60d21b4667d0d8992e610c87"))
    ...
    def test_get_submission(self, submission_model, mock_collection):
        ...
        mock_collection.find_one.assert_called_once_with({"_id": ObjectId(submission_id)})
    ...
    def test_delete_by_assignment(self, submission_model, mock_collection):
        ...
        # Verify
        assert result == 5
        mock_collection.delete_many.assert_called_once_with({"assignment_id": assignment_id})