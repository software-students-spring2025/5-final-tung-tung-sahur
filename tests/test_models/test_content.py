...
class TestContentModel:
    ...
    def test_create_content(self, content_model, mock_collection):
        ...
        mock_collection.insert_one.return_value = MagicMock(inserted_id=ObjectId("60d21b4667d0d8992e610c88"))
    ...
    def test_delete_content(self, content_model, mock_collection):
        ...
        # Verify
        assert result is True
        mock_collection.delete_one.assert_called_once_with({"_id": ObjectId(content_id)})
