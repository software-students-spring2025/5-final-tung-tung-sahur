...
class TestAssignmentRoutes:
    ...
    def test_show_assignments_teacher(self, mock_asgM, mock_subM, mock_users, mock_render, client):
        # Arrange
    ...
    @patch('routes.assignmentRoute.submission_model')
    @patch('routes.assignmentRoute.assignment_model')
    def test_show_assignments_student(self, mock_asgM, mock_subM, mock_users, mock_render, client):
        # Arrange
        now = datetime.now()
        fake_asg = [
        ...
        mock_users.find_one.return_value = {"_id": ObjectId(), "username": "student", "identity": "student"}
    ...
    def test_submit_assignment(self, mock_subM, mock_users, mock_redirect, client):
        ...
        mock_users.find_one.return_value = {"_id": ObjectId(), "username": "stud", "identity": "student"}
        ...
        mock_subM.create_submission.assert_called_once_with(
            ...
            github_link="L", readme_content="C"
        )
